...
/**
 * /embeds lists them; /embed/{name} is one of them. The listing used to sit a
 * segment deeper at /embeds/directory, mirroring assembly.com's /apps/directory,
 * with the bare category redirecting to it — two URLs for one page, and a
 * segment in every embed's address that named the page rather than the thing.
 */
// Editors publish to Contentful, not to git, so the listing picks up a new
        ...
        <section className="mx-auto max-w-[1200px] px-6 pb-24 pt-16 md:px-10 md:pb-32 md:pt-24">
          {embeds.length === 0 ? (
            <p className="type-body text-muted-foreground">
              The embed directory is unavailable right now. Please try again
              shortly.
            </p>
          ) : (
