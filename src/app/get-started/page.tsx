...
function GetStartedShell({
  ...
  return (
    ...
    <div className="relative flex min-h-screen items-end justify-center sm:items-center sm:p-6">
      ...
      {/* The content is a white sheet over that, sized to what's in it rather
          than filling the window. Below sm it's a bottom sheet: the full width of
          the screen, sat on its floor with the top corners rounded, which is the
          native shape there — capped to a card at that width it read as a panel
          stuck to the bottom rather than a sheet. From sm up it lifts off,
          centres and takes its measure back. */}
      ...
      <main className="relative z-10 w-full rounded-t-[24px] bg-background px-6 pb-12 pt-8 sm:max-w-md sm:rounded-[24px] sm:px-10 sm:py-12 sm:shadow-[0_30px_80px_-50px_rgba(0,0,0,0.55)] [[data-theme=dark]_&]:bg-[#171717] [[data-theme=dark]_&]:ring-1 [[data-theme=dark]_&]:ring-white/[0.10]">
        <div>
