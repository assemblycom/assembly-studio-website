...
const FAQS: FAQEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Other AI builders spin up slick prototypes that are difficult to make production-ready, and they often never make it in front of a client. Assembly Studio closes that gap. Because Assembly has a CRM and client experience foundation built in, the apps you describe go live where your team and clients already are: hosting, authentication, permissions, payments, notifications, and branding all handled securely for you. You build the part that's distinctly yours; Assembly already runs the rest.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. There are 30+ app templates covering common workflows and specific industries, from accounting document collection to agency approval flows. Start from one and it's yours: reshape it by chat until it fits exactly how your firm works. Templates are a great fit if you'd rather start from something proven than describe an app from scratch.",
  },
  {
